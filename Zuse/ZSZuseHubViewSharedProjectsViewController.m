//
//  ZSZuseHubViewSharedProjectsViewController.m
//  Zuse
//
...
@implementation ZSZuseHubViewSharedProjectsViewController
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if(self.contentType == ZSZuseHubMyHubTypeViewMySharedProjects)
    {
        ...
        if(self.jsonProjects.count == 0)
            cellText = @"No shared projects by this user";
        else
        {
...
-(NSString*)tableView:(UITableView *)tableView titleForHeaderInSection:(NSInteger)section
{
    if(self.contentType == ZSZuseHubMyHubTypeViewMySharedProjects)
        ...
        return @"Error something went wrong with viewing shared projects";
}
